...
public class perpus {
  public static void main(String[] args) {
   ...
   dataMahasiswa.add(new Mahasiswa("20200040161", "Riza Rumayanti Dewi"));
   dataMahasiswa.add(new Mahasiswa("20200040041", "Gilang Permana"));
   dataMahasiswa.add(new Mahasiswa("20200040001", "Nessa Sari Putri"));
   dataMahasiswa.add(new Mahasiswa("20200040016", "Reva Marisa Tejaningrum"));
   dataMahasiswa.add(new Mahasiswa("20200040009", "Rifa Haura Sakhi"));

    ArrayList <Buku> dataBuku = new ArrayList<>(); 

    dataBuku.add(new Buku("00NPU2720", "Sherlock Holmes Short Stories"));
    dataBuku.add(new Buku("EB0230", "William"));
    dataBuku.add(new Buku("EB0223", "Samantha"));
    dataBuku.add(new Buku("EB0011", "Mariposa"));
    dataBuku.add(new Buku("EB0184", "Asih"));
